...
const (
	ClientService_GetClients_FullMethodName   = "/protos.ClientService/GetClients"
	ClientService_CreateClient_FullMethodName = "/protos.ClientService/CreateClient"
	ClientService_UpdateClient_FullMethodName = "/protos.ClientService/UpdateClient"
)
...
type ClientServiceClient interface {
	GetClients(ctx context.Context, in *GetClientsRequest, opts ...grpc.CallOption) (*ClientsResponse, error)
...
func (c *clientServiceClient) GetClients(ctx context.Context, in *GetClientsRequest, opts ...grpc.CallOption) (*ClientsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ClientsResponse)
	err := c.cc.Invoke(ctx, ClientService_GetClients_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ClientServiceServer interface {
	GetClients(context.Context, *GetClientsRequest) (*ClientsResponse, error)
...
func (UnimplementedClientServiceServer) GetClients(context.Context, *GetClientsRequest) (*ClientsResponse, error) {
